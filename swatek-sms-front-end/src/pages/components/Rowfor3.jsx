...
const Rowfor3 = ({id, nompack ,prix ,nbrsms , validite,dateD,dateF }) => {
    ...
    return (
        ...
        <div class="card border-dark p-3 text-center">
                    ...
                    <Modal.Body>
                     <Demandeachat id={id} nompack={nompack} prix={prix} nbrsms={nbrsms}  validite={validite} dateD={dateD} dateF={dateF} />
                    </Modal.Body>
                    <Modal.Footer>
